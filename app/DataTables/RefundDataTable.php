    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('shop_id', function ($query) {
                return $query->name;//todo link this to shop page
            })
             ->editColumn('by_admin', function ($query) {
                return $query->by_admin;
            })
            ->editColumn('approve_date', function ($query) {
                return verta($query->approve_date)->timezone('Asia/Tehran')->format('Y-m-d H:i');
            })
            ->editColumn('pay_date', function ($query) {
                return verta($query->pay_date)->timezone('Asia/Tehran')->format('Y-m-d H:i');
            })

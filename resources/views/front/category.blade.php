...
:\App\Http\Core\Models\Image::NO_IMAGE_PATH)}}" alt="">
                            ...
                            <div class="thumb-responsive w-100 mt-3"><a class="w-100 d-flex" href="#">
                                    <img class="job-small-thumb-img" src="img/product-thumb-1.jpg" alt="">
                                    <div class="position-relative pt-2">
                                        <div class="cart-item-title">دوره آموزش آنلاین زبان انگلیسی در آموزشگاه زبان
                                            تیکا
                                        </div>
                                        ...
                                        <div class="cart-off-value text-center">90%</div>
                                    </div>
                                </a></div>
                        @endforeach
                    </div>

<form action="{{ route('shop.refund.update', $refund->id) }}" method="post" autocomplete="off"
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <textarea name="description" class="form-control description" cols="30" rows="5">{!! $refund->description !!}</textarea>
                <div class="error_field text-danger">  </div>
            </div>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary">ویرایش درخواست</button>
        </div>
    </div>
</form>
<script>

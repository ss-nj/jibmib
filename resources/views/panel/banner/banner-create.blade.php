...
@section('title')ایجاد بنرها@endsection
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12 box-margin">
                <form action="{{route('banner.store')}}" class="ajax_validate" method="post"
                      enctype="multipart/form-data">
                    @csrf

                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title mb-2">ایجاد بنر</h4>
                                    ...
                                    <div class="form-group">
                                        <select
                                            ...
                                            id="place_id"
                                                ...
                                                class="form-control mySelect2 place_id"
                                                style="width: 100%;">

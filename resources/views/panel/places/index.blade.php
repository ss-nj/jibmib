...
@section('title')مدیریت مناطق@endsection
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xl-12 box-margin">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-2">لیست مناطق</h4>
                        <div class="portlet light row ">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <label for="ajaxSlug" class="form-control-label">نامک(قسمت انتهایی لینک صفحه) :</label>

                                <div class="form-group">
                                    <input type="text" class="ajaxSlug form-control" id="ajaxSlug" name="ajaxSlug">
                                </div>
                            </div>

                             <div class="form-group col-md-4">

                                <label for="ajaxCity" class="form-control-label">شهر:</label>

                                <div class="form-group">
                                    <input type="text" class="ajaxCity form-control" id="ajaxCity" name="ajaxCity">
                                </div>
                            </div>
    ...
    @include('panel.places.new-place')
...
@push('scripts')
    <script>
        ...
        $(document).on('click', '.model-edit', function (e) {
            ...
            $.ajax({
                type: "post",
                url: "{{url('panel/crm/places/ajax/edit')}}" + '/' + Id,
        ...
        var dataTable = $('#places-table').DataTable({
            'pageLength': 15,
            'processing': true,
            'serverSide': true,
            'serverMethod': 'get',
            ...
            columns: [
                ...
                {data: 'slug', name: 'slug', title: 'نامک', 'className': 'text-center', orderable: false},
                {data: 'city_id', name: 'city_id', title: 'شهر', 'className': 'text-center', orderable: false},

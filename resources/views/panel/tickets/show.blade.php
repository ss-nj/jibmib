                ...
                <div class="card card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12">
                            <form action="{{route('panel.store.message')}}" class="ajax_validate" method="post">
                                @csrf
                                            ...
                                            <table class="table table-bordered margin-btm-0">
                                                ...
                                                @foreach($messages as $message)
                                                    <tr style="background :{{$message->from_admin?'#c6c6c6':''}}">
                                                        ...
                                                        <td class="text-center">
                                                            <div class="custom-cart">{{$message->user?$message->user->full_name:''}}</div>
                                                        </td>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                       <textarea class="form-control" id="ticket-description" rows="8" name="body"
{{--                                                 required--}}

...
// search mobile screen **f.falahi
$(document).ready(function(){
// animate search to show
$("#searchMobile").click(function () { 
    $(document).scrollTop(0);
    $("#side-filter").toggle("slow");
    $("#side-filter").addClass("animated slideInRight");
  });
//   end
// stop search button before footer
  $(window).scroll(function () {   
    if($(window).scrollTop() > 200) {
       $('.searchMobile-icon').css('position','fixed');
       $('.searchMobile-icon').css('top','0'); 
    }
    else if ($(window).scrollTop() <= 200) {
       $('.searchMobile-icon').css('position','');
       $('.searchMobile-icon').css('top','');
    }  
       if ($('.searchMobile-icon').offset().top + $(".searchMobile-icon").height() > $(".main-footer").offset().top) {
           $('.searchMobile-icon').css('top',-($(".searchMobile-icon").offset().top + $(".searchMobile-icon").height() - $(".main-footer").offset().top));
       }
   });
//    end
   });  
// *****end search mobile screen **f.falahi